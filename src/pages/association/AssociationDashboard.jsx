...
const AssociationDashboard = () => {
  ...
  const associationData = {
    ...
    metrics: [
      {
        name: "Cumplimiento de Declaraciones",
        value: 96,
        target: 95,
        status: "excelente",
      ...
      {
        name: "Cumplimiento de Expedientes",
        value: 91,
        target: 90,
        status: "excelente",
        icon: FolderIcon,
  ...
  return (
    ...
    >
      <Container maxWidth="xl">
              ...
              <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                ...
                <Box>
                  ...
                  <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
                    ...
                    >
                      RFC: {associationData.info.rfc} • ID:{" "}
                      {associationData.info.id}
                    </Typography>
                  </Stack>
        ...
        <Grid
          container
          sx={{ mb: 4, display: "flex", flexWrap: "nowrap", gap: 2 }}
        >
          {associationData.areas
            .concat(associationData.metrics)
            .map((item, index) => {
        ...
        >
          ...
          >
            <Typography
              variant="h6"
              sx={{ fontWeight: 700, color: institutionalColors.textPrimary }}
            >
                  ...
                  <TableRow key={member.id} hover>
                    ...
                    <TableCell>
                      <Chip
                        ...
                        sx={{
                          bgcolor:
                            member.status === "activo" ? "#d1fae5" : "#fee2e2",
                          color:
