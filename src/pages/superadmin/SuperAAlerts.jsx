...
// Datos mock de alertas para ADMINISTRADOR
const alerts = [
  { 
    id: 1, 
    type: 'warning', 
    title: 'Certificaciones por Vencer', 
    message: '5 certificaciones vencerán en los próximos 3 días. Se recomienda revisar y notificar a los usuarios correspondientes para evitar incumplimientos.', 
  ...
  { 
    id: 2, 
    type: 'error', 
    title: 'Certificación Rechazada por Revisor', 
    message: 'La certificación OS-2025-03421 fue rechazada por el revisor asignado debido a documentación incompleta. Se requiere seguimiento administrativo.', 
    date: '14/01/2026 15:45', 
    time: 'Hace 1 día',
    read: false,
    priority: 'alta',
    source: 'Módulo de Certificaciones',
    certificationNumber: 'OS-2025-03421',
    user: { name: 'Ana López', avatar: 'AL', type: 'Profesionista' },
    region: 'Centro',
    actions: ['review', 'contactUser', 'assignReviewer'],
    requiresAction: true,
    category: 'rechazo'
  },
  ...
  { 
    ...
    message: 'Un nuevo usuario se ha registrado en el sistema y está pendiente de validación administrativa.', 
    date: '14/01/2026 09:15', 
    time: 'Hace 1 día',
    read: false,
    priority: 'media',
    source: 'Gestión de Usuarios',
    certificationNumber: null,
    user: { name: 'Carlos Martínez', avatar: 'CM', type: 'Profesionista' },
    region: 'Sur',
    actions: ['reviewUser', 'approveUser', 'rejectUser'],
    requiresAction: true,
    category: 'usuario'
  },
  ...
  { 
    id: 4, 
    type: 'warning', 
    title: 'Instancia sin Administrador Asignado', 
    message: 'La instancia "Zona Norte" no tiene administrador asignado. Esto puede afectar la gestión operativa.', 
    date: '13/01/2026 16:20', 
    time: 'Hace 2 días',
    read: false,
    priority: 'alta',
    source: 'Gestión de Instancias',
    certificationNumber: null,
    user: null,
    region: 'Norte',
    actions: ['assignAdmin', 'reviewInstance'],
    requiresAction: true,
    category: 'instancia'
  },
  ...
  { 
    ...
    message: 'La certificación PN-2025-12345 ha sido aprobada correctamente por el revisor asignado.', 
  ...
  { 
    ...
    message: 'Se detectó un error en el servicio de sincronización de documentos. Puede afectar múltiples certificaciones.', 
    ...
    user: null,
    region: 'Global',
    actions: ['viewLogs', 'contactSupport'],
    requiresAction: true,
    category: 'sistema'
  },
  ...
  { 
    ...
    message: 'Se ha creado una nueva instancia en el sistema. Se requiere configuración inicial.', 
    date: '11/01/2026 10:00',
    time: 'Hace 4 días',
    read: false,
    priority: 'media',
    source: 'Gestión de Instancias',
  ...
  { 
    id: 8, 
    type: 'warning', 
    title: 'Alta Carga en el Sistema', 
    message: 'El sistema registra alta carga de solicitudes. Puede afectar el rendimiento.', 
    date: '10/01/2026 18:30',
    time: 'Hace 5 días',
    read: true,
    priority: 'media',
    source: 'Monitor del Sistema',
    certificationNumber: null,
    user: null,
    region: 'Global',
    actions: ['viewMetrics'],
