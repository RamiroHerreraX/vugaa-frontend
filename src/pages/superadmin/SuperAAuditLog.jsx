          ...
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth size="small">
                ...
                <Select value={filterInstancia} label="Instancia"
                  onChange={(e) => { setFilterInstancia(e.target.value); setPage(1); }}
                  startAdornment={
                    <InputAdornment position="start">
                  ...
                  {instancias.map(ins => <MenuItem key={ins.id} value={ins.id}>{ins.name}</MenuItem>)}
                </Select>
              </FormControl>
            </Grid>
